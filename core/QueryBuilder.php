...
trait QueryBuilder{
	...
	function update($data){
		...
		$updateStatus = $this->updateData($this->tableName,$data, $whereUpdate);
		return $updateStatus;
	}
	...
	public function delete()
	{
		...
		$deleteStatus = $this->deleteData($this->tableName,$whereDelete);
		return $deleteStatus;
	}

	public function join($tableName, $realtionship)
	{
		$this->innerJoin .= "INNER JOIN $tableName ON $realtionship ";
		return $this;
	}
